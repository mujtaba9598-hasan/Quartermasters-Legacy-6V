...
interface ScrollStackProps {
  children: ReactNode;
  className?: string;
  /** Distance (px) between cards in normal flow */
  itemDistance?: number;
  /** Scale reduction per card depth (0-1) */
  itemScale?: number;
  /** Distance (px) between stacked cards when pinned */
  itemStackDistance?: number;
  /** Scroll position where cards start pinning (px or '%') */
  stackPosition?: string | number;
  /** Scroll position where scale animation ends (px or '%') */
  scaleEndPosition?: string | number;
  /** Minimum scale for deepest card */
  baseScale?: number;
  /** Duration hint for scale transitions */
  scaleDuration?: number;
  /** Rotation amount per card depth (degrees) */
  rotationAmount?: number;
  /** Blur amount per card depth (px) */
  blurAmount?: number;
  /** Use window scroll instead of container scroll */
  useWindowScroll?: boolean;
  /** Callback when all cards are stacked */
